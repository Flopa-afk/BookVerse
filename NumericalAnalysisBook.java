...
public class NumericalAnalysisBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(NumericalAnalysisBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgMath/NumericalAnalysis.jpg");
        ...
        JLabel title = new JLabel("Numerical Analysis");
        ...
        JLabel lblTitle = new JLabel("Numerical Analysis");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This book provides a comprehensive introduction to numerical analysis, covering fundamental concepts and techniques for solving mathematical problems using numerical methods. Topics include root finding, interpolation, numerical integration, and the numerical solution of ordinary differential equations. With practical examples and exercises, this book is an essential resource for students and professionals in mathematics, engineering, and computer science.");
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Numerical Analysis", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Numerical Analysis", "Youssef N. Raffoul", priceText + " DA", "BooksImg\\ImgMath/NumericalAnalysis.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Numerical Analysis"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = NumericalAnalysisBook.class.getResource(path.startsWith("/") ? path : "/" + path);
