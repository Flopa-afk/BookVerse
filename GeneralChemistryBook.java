...
public class GeneralChemistryBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(GeneralChemistryBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgChemistry/GeneralChemistry.jpg");
        ...
        JLabel title = new JLabel("General Chemistry");
        ...
        JLabel lblTitle = new JLabel("General Chemistry");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This comprehensive guide to general chemistry covers fundamental concepts such as atomic structure, chemical bonding, stoichiometry, thermodynamics, and kinetics. Ideal for students and enthusiasts alike, it provides clear explanations, practical examples, and engaging illustrations to enhance understanding of the subject.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("General Chemistry"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "General Chemistry", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("General Chemistry", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgChemistry/GeneralChemistry.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("General Chemistry"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = GeneralChemistryBook.class.getResource(path.startsWith("/") ? path : "/" + path);
