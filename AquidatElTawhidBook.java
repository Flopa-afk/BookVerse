...
public class AquidatElTawhidBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AquidatElTawhidBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgIslamic/Aquidat_Tawhid.jpg");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Aquidat El Tawhid"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Aquidat Al Tawhid", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                int finalQuantity = dialog.getQuantity();
                CartManager.addBook("Aquidat Al Tawhid", "Dr. Saleh El fawzan", priceText + " DA", "BooksImg\\ImgIslamic/Aquidat_Tawhid.jpg", finalQuantity);
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = AquidatElTawhidBook.class.getResource(path.startsWith("/") ? path : "/" + path);
