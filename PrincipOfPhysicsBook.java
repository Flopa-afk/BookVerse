...
public class PrincipOfPhysicsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(PrincipOfPhysicsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgPhysics/PrincipOfPhysics.jpg");
        ...
        JLabel title = new JLabel("Princip Of Physics");
        ...
        JLabel lblTitle = new JLabel("Princip Of Physics");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("A comprehensive introduction to the fundamental concepts of physics, covering mechanics, electricity, magnetism, and more. Ideal for students and science enthusiasts.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Princip Of Physics"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Principles Of Physics", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Principles Of Physics", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgPhysics/PrinciplesOfPhysics.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Princip Of Physics"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = PrincipOfPhysicsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
