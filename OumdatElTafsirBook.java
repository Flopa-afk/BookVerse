...
public class OumdatElTafsirBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(OumdatElTafsirBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgIslamic/Oumdat_El_Tafsir.jpg");
        ...
        JLabel title = new JLabel("Oumdat El Tafsir");
        title.setFont(new Font("Serif", Font.BOLD, 22));
        title.setForeground(new Color(60, 0, 90));
        left.add(title);

        JLabel author = new JLabel("by Imam Ibn Kathir");
        ...
        JLabel lblTitle = new JLabel("Oumdat El Tafsir");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Oumdat El Tafsir is a comprehensive commentary on the Quran by the renowned Islamic scholar Imam Ibn Kathir. This book provides detailed explanations of Quranic verses, drawing from authentic hadiths and scholarly interpretations. It serves as an invaluable resource for understanding the deeper meanings and contexts of the Holy Quran, making it essential for students and scholars of Islamic studies.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Oumdat El Tafsir"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Oumdat El Tafsir", priceText + " DA");
            dialog.setVisible(true);
            
            // If user confirmed in the dialog, use their selected quantity and add to cart
            if (dialog.isConfirmed()) {
                int finalQuantity = dialog.getQuantity();
                CartManager.addBook("Oumdat El Tafsir", "Imam Ibn Kathir", priceText + " DA", "BooksImg\\ImgIslamic/Oumdat_El_Tafsir.jpg", finalQuantity);
        ...
        categories.add(categoryChip("Tafsir"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = OumdatElTafsirBook.class.getResource(path.startsWith("/") ? path : "/" + path);
