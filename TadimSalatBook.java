...
public class TadimSalatBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(TadimSalatBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgIslamic/Tadim_Salat.jpg");
        ...
        JLabel title = new JLabel("Tadim El Salat");
        title.setFont(new Font("Serif", Font.BOLD, 22));
        title.setForeground(new Color(60, 0, 90));
        left.add(title);

        JLabel author = new JLabel("by Dr.Abd El Razeque El Badr");
        ...
        JLabel lblTitle = new JLabel("Tadim El Salat");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Tadim El Salat is a comprehensive guide to the proper performance of Islamic prayers (Salah). Written by Dr. Abd El Razeque El Badr, this book provides detailed instructions on the steps, recitations, and spiritual aspects of Salah. It is an essential resource for Muslims seeking to perfect their worship and deepen their connection with Allah.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Tadim El Salat"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Tadim El Salat", priceText + " DA");
            dialog.setVisible(true);
            
            // If user confirmed in the dialog, use their selected quantity and add to cart
            if (dialog.isConfirmed()) {
                int finalQuantity = dialog.getQuantity();
                CartManager.addBook("Tadim El Salat", "Dr.Abd El Razeque El Badr", priceText + " DA", "BooksImg\\ImgIslamic/Tadim_Salat.jpg", finalQuantity);
        ...
        categories.add(categoryChip("Prayer"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = TadimSalatBook.class.getResource(path.startsWith("/") ? path : "/" + path);
