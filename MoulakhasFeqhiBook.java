...
public class MoulakhasFeqhiBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(MoulakhasFeqhiBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgIslamic/El_Moulakhas_El_Fequhi.jpg");
        ...
        JLabel title = new JLabel("Moulakhas El Feqhi");
        ...
        JLabel lblTitle = new JLabel("Moulakhas El Feqhi");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Moulakhas El Feqhi is a concise summary of Islamic jurisprudence (Fiqh) principles. Authored by Dr. Saleh El Fawzan, this book covers key aspects of Islamic law, including worship, transactions, and social interactions. It serves as an essential guide for Muslims seeking to understand and apply Sharia in their lives.");
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Moulakhas El Feqhi", priceText + " DA");
            dialog.setVisible(true);
            
            // If user confirmed in the dialog, use their selected quantity and add to cart
            if (dialog.isConfirmed()) {
                int finalQuantity = dialog.getQuantity();
                CartManager.addBook("Moulakhas El Feqhi", "Dr. Saleh El fawzan", priceText + " DA", "BooksImg\\ImgIslamic/El_Moulakhas_El_Fequhi.jpg", finalQuantity);
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = MoulakhasFeqhiBook.class.getResource(path.startsWith("/") ? path : "/" + path);
