...
public class SoftwareArchitectureBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(SoftwareArchitectureBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgAlgo/SoftwareArchitecture.jpg");
        ...
        JLabel title = new JLabel("Software Architecture");
        title.setFont(new Font("Serif", Font.BOLD, 22));
        title.setForeground(new Color(60, 0, 90));
        left.add(title);

        JLabel author = new JLabel("by Tim Roughgarden");
        ...
        JLabel lblTitle = new JLabel("Software Architecture");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Software Architecture provides a comprehensive overview of the principles and practices of designing robust software systems. Written by Simon Tellier, this book covers essential topics such as architectural patterns, design principles, and best practices for building scalable and maintainable software applications. Whether you're a software developer, architect, or student, this book offers valuable insights to help you create effective software architectures.");
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Software Architecture", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Software Architecture", "Tim Roughgarden", priceText + " DA", "BooksImg\\ImgAlgo/SoftwareArchitecture.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Programming"));
        categories.add(categoryChip("Algorithms"));
        categories.add(categoryChip("Computer Science"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = SoftwareArchitectureBook.class.getResource(path.startsWith("/") ? path : "/" + path);
