...
public class AdvancedDifferentialEquationsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AdvancedDifferentialEquationsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgMath/AdvancedDefferentialEquations.jpg");
        ...
        JLabel title = new JLabel("Advanced Differential Equations");
        ...
        JLabel lblTitle = new JLabel("Advanced Differential Equations");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Advanced Differential Equations by Youssef N. Raffoul provides a comprehensive exploration of differential equations, covering advanced topics such as stability theory, bifurcation, and numerical methods. This book is ideal for graduate students and researchers in mathematics and applied sciences.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Advanced Defferential Equations"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Advanced Differential Equations", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Advanced Differential Equations", "Youssef N. Raffoul", priceText + " DA", "BooksImg\\ImgMath/AdvancedDifferentialEquations.jpg", dialog.getQuantity());
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = AdvancedDifferentialEquationsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
