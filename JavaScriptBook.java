...
public class JavaScriptBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(JavaScriptBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgAlgo/JavaScript.jpg");
        ...
        JLabel title = new JLabel("JavaScript Programming For Data Analysis");
        title.setFont(new Font("Serif", Font.BOLD, 22));
        title.setForeground(new Color(60, 0, 90));
        left.add(title);

        JLabel author = new JLabel("by F. Engineer");
        ...
        JLabel lblTitle = new JLabel("JavaScript Programming For Data Analysis");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This comprehensive guide delves into JavaScript's capabilities for data analysis, covering essential libraries, techniques, and best practices to empower developers in extracting insights from complex datasets.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("JavaScript Programming For Data Analysis"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "JavaScript Programming For Data Analysis", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("JavaScript Programming For Data Analysis", "F. Engineer", priceText + " DA", "BooksImg\\ImgAlgo/JavaScript.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("JavaScript Programming For Data Analysis"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = JavaScriptBook.class.getResource(path.startsWith("/") ? path : "/" + path);
