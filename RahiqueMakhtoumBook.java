...
public class RahiqueMakhtoumBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(RahiqueMakhtoumBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgIslamic/Rahique_Makhtoum.jpg");
        ...
        JLabel title = new JLabel("El Rahique El Makhtoum");
        title.setFont(new Font("Serif", Font.BOLD, 22));
        title.setForeground(new Color(60, 0, 90));
        left.add(title);

        JLabel author = new JLabel("by Imam Moubarkfouri");
        ...
        JLabel lblTitle = new JLabel("El Rahique El Makhtoum");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("El Rahique El Makhtoum is a renowned Islamic text that provides guidance on the principles of Islamic jurisprudence and ethics. Authored by Imam Moubarkfouri, this book is a valuable resource for understanding the foundations of Islamic law and its application in daily life. It is widely studied by scholars and students alike for its clarity and depth.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("El Rahique El Makhtoum"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "El Rahique El Makhtoum", priceText + " DA");
            dialog.setVisible(true);
            
            // If user confirmed in the dialog, use their selected quantity and add to cart
            if (dialog.isConfirmed()) {
                int finalQuantity = dialog.getQuantity();
                CartManager.addBook("El Rahique El Makhtoum", "Imam Moubarkfouri", priceText + " DA", "BooksImg\\ImgIslamic/Rahique_Makhtoum.jpg", finalQuantity);
        ...
        categories.add(categoryChip("Fiqh"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = RahiqueMakhtoumBook.class.getResource(path.startsWith("/") ? path : "/" + path);
