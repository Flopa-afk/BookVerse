...
public class NuclearAndParticlePhysicsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(NuclearAndParticlePhysicsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgPhysics/NuclearAndParticlePhysics.jpg");
        ...
        JLabel title = new JLabel("Nuclear And Particle Physics");
        ...
        JLabel lblTitle = new JLabel("Nuclear And Particle Physics");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Discover the mysteries of the universe with 'Nuclear And Particle Physics,' an essential book that explores the foundations of matter and the forces that govern our cosmos. Dive into the key concepts of nuclear and particle physics, illustrated with concrete examples and modern applications. Whether you are a student, researcher, or science enthusiast, this book offers you a deep understanding of subatomic phenomena and their impact on our world.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Nuclear And Particle Physics"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Nuclear And Particle Physics", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Nuclear And Particle Physics", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgPhysics/NuclearAndParticlePhysics.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Origin Of Mass"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = NuclearAndParticlePhysicsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
