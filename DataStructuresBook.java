...
public class DataStructuresBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(DataStructuresBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgAlgo/DataStructures.jpg");
        ...
        JTextArea desc = new JTextArea("Data Structures is a fundamental guide to understanding and implementing essential data structures in computer science. Written by F. Engineer, this book covers arrays, linked lists, stacks, queues, trees, and graphs, providing clear explanations and practical examples for efficient programming.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Data Structures"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Data Structures", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Data Structures", "F. Engineer", priceText + " DA", "BooksImg\\ImgAlgo/DataStructures.jpg", dialog.getQuantity());
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = DataStructuresBook.class.getResource(path.startsWith("/") ? path : "/" + path);
