...
public class ChemistryBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(ChemistryBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgChemistry/Chemistry.jpg");
        ...
        JLabel title = new JLabel("Chemistry");
        ...
        JLabel lblTitle = new JLabel("Chemistry");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This comprehensive guide to chemistry covers fundamental concepts such as atomic structure, chemical bonding, stoichiometry, thermodynamics, and kinetics. Ideal for students and enthusiasts alike, it provides clear explanations, practical examples, and engaging illustrations to enhance understanding of the subject.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Chemistry"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Chemistry", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Chemistry", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgChemistry/Chemistry.jpg", dialog.getQuantity());
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = ChemistryBook.class.getResource(path.startsWith("/") ? path : "/" + path);
