...
public class MasteringAlgebraBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(MasteringAlgebraBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgMath/MasteringAlgebra.jpg");
        ...
        JLabel title = new JLabel("Mastering Algebra");
        ...
        JLabel lblTitle = new JLabel("Mastering Algebra");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("this book offers a comprehensive exploration of algebraic concepts, "
                + "ranging from fundamental principles to advanced techniques. "
                + "Designed for students and enthusiasts alike, it provides clear explanations, "
                + "practical examples, and a variety of exercises to enhance understanding and proficiency in algebra.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Mastering Algebra"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Mastering Algebra", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Mastering Algebra", "Youssef N. Raffoul", priceText + " DA", "BooksImg\\ImgMath/MasteringAlgebra.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Mastering Algebra"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = MasteringAlgebraBook.class.getResource(path.startsWith("/") ? path : "/" + path);
