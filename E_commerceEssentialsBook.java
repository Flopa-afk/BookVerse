...
public class E_commerceEssentialsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(E_commerceEssentialsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\\\\\\\ImgE_commerce/E_commeceEssentials.jpg");
        ...
        JLabel title = new JLabel("E_commece Essentials");
        ...
        JLabel lblTitle = new JLabel("E_commece Essentials");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This book provides a comprehensive overview of e-commerce essentials, covering topics such as online business models, digital marketing strategies, payment systems, and customer relationship management. It is an invaluable resource for anyone looking to understand the fundamentals of e-commerce and succeed in the digital marketplace.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("E_commece Essentials"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "E-commerce Essentials", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("E-commerce Essentials", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgE_commerce/E_commerceEssentials.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("E_commece Essentials"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = E_commerceEssentialsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
