...
public class AlgorithmsIlluminatedBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AlgorithmsIlluminatedBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgAlgo/AlgorithmsIlluminated.jpg");
        ...
        JLabel title = new JLabel("Algorithms Illuminated");
        ...
        JLabel lblTitle = new JLabel("Algorithms Illuminated");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Algorithms Illuminated is a comprehensive guide to understanding algorithms through a clear and intuitive approach. Written by Tim Roughgarden, this book breaks down complex algorithmic concepts into accessible explanations, making it an essential resource for students and professionals in computer science.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Algorithms Illuminated"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Algorithms Illuminated", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Algorithms Illuminated", "Tim Roughgarden", priceText + " DA", "BooksImg\\ImgAlgo/AlgorithmsIlluminated.jpg", dialog.getQuantity());
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = AlgorithmsIlluminatedBook.class.getResource(path.startsWith("/") ? path : "/" + path);
