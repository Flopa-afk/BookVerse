...
public class OrganicChemistryBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(OrganicChemistryBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgChemistry/OrganicChemistry.jpg");
        ...
        JLabel title = new JLabel("Organic Chemistry");
        ...
        JLabel lblTitle = new JLabel("Organic Chemistry");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This comprehensive guide to organic chemistry covers fundamental concepts such as molecular structure, functional groups, reaction mechanisms, and synthesis strategies. Ideal for students and enthusiasts alike, it provides clear explanations, practical examples, and engaging illustrations to enhance understanding of the subject.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Organic Chemistry"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Organic Chemistry", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Organic Chemistry", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgChemistry/OrganicChemistry.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Chemistry"));
        categories.add(categoryChip("Organic Chemistry"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = OrganicChemistryBook.class.getResource(path.startsWith("/") ? path : "/" + path);
