...
public class QuantumPhysicsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(QuantumPhysicsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgPhysics/QuantumPhysics.jpg");
        ...
        JLabel title = new JLabel("QuantumP hysics");
        ...
        JLabel lblTitle = new JLabel("Quantum Physics");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Explore the fascinating world of Quantum Physics with this comprehensive guide. Delve into the principles that govern the behavior of matter and energy at the smallest scales, and discover how these concepts shape our understanding of the universe.");
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Quantum Physics", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Quantum Physics", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgPhysics/QuantumPhysics.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Quantum Physics"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = QuantumPhysicsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
