...
public class PureMathematicsBook {
    ...
    private static JPanel createMainPanel() {
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Pure Mathematics"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Pure Mathematics", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Pure Mathematics", "Youssef N. Raffoul", priceText + " DA", "BooksImg\\ImgMath/PureMathematics.jpg", dialog.getQuantity());
