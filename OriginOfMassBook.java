...
public class OriginOfMassBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(OriginOfMassBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgPhysics/OriginOfMass.jpg");
        ...
        JLabel title = new JLabel("Origin Of Mass");
        ...
        JLabel lblTitle = new JLabel("Origin Of Mass");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This book delves into the fundamental concepts of mass in physics, exploring its origins and implications in the universe. It covers topics such as mass-energy equivalence, the Higgs mechanism, and the role of mass in cosmology. Designed for students and enthusiasts alike, it provides a comprehensive understanding of one of the most intriguing aspects of modern physics.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Origin Of Mass"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Origin Of Mass", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Origin Of Mass", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgPhysics/OriginOfMass.jpg", dialog.getQuantity());
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = OriginOfMassBook.class.getResource(path.startsWith("/") ? path : "/" + path);
