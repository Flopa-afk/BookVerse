...
public class AppliedMathematicsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(AppliedMathematicsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgMath/AppliedMathematics.jpg");
        ...
        JLabel title = new JLabel("Applied Mathematics");
        ...
        JLabel lblTitle = new JLabel("Applied Mathematics");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This book provides a comprehensive introduction to applied mathematics, covering essential topics such as differential equations, linear algebra, and numerical methods. It is designed for students and professionals seeking to enhance their mathematical skills for practical applications in science and engineering.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Applied Mathematics"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Applied Mathematics", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Applied Mathematics", "Youssef N. Raffoul", priceText + " DA", "BooksImg\\ImgMath/AppliedMathematics.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Applied Mathematics"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = AppliedMathematicsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
