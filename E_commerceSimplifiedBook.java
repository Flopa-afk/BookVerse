...
public class E_commerceSimplifiedBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(E_commerceSimplifiedBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\\\ImgE_commerce/E_commerceSimplified.jpg");
        ...
        JLabel title = new JLabel("E_commerce Simplified");
        ...
        JLabel lblTitle = new JLabel("E_commerce Simplified");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Discover the fundamentals of E_commerce with 'E_commerce Simplified' by Luis Val. This comprehensive guide covers essential topics such as online business models, digital marketing strategies, payment systems, and customer relationship management. Perfect for beginners and professionals alike, this book provides practical insights and real-world examples to help you navigate the dynamic world of E_commerce.");
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "E-commerce Simplified", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("E-commerce Simplified", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgE_commerce/E_commerceSimplified.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("E_commece"));
        categories.add(categoryChip("E_commerce Simplified"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = E_commerceSimplifiedBook.class.getResource(path.startsWith("/") ? path : "/" + path);
