...
public class ConceptsInThermalPhysicsBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(ConceptsInThermalPhysicsBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgPhysics/ConceptsInThermalPhysics.jpg");
        ...
        JLabel title = new JLabel("Concepts In Thermal Physics");
        ...
        JLabel lblTitle = new JLabel("Concepts In Thermal Physics");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("Concepts In Thermal Physics by Jhon Ilpoulous provides a comprehensive introduction to the principles of thermal physics. Covering topics such as thermodynamics, statistical mechanics, and kinetic theory, this book is designed for undergraduate students in physics and engineering. It offers clear explanations, practical examples, and problem-solving techniques to help readers grasp the fundamental concepts of thermal phenomena.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Concepts In Thermal Physics"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Concepts In Thermal Physics", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Concepts In Thermal Physics", "Jhon Ilpoulous", priceText + " DA", "BooksImg\\ImgPhysics/ConceptsInThermalPhysics.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Concepts In Thermal Physics"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = ConceptsInThermalPhysicsBook.class.getResource(path.startsWith("/") ? path : "/" + path);
