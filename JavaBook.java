...
public class JavaBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(JavaBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgAlgo/Java.jpg");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Java For Beginners"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Java", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Java", "F. Engineer", priceText + " DA", "BooksImg\\ImgAlgo/Java.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Java"));
