...
public class FundamrntalsOfProbabilityBook {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(FundamrntalsOfProbabilityBook::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgMath/FundamrntalsOfProbability.jpg");
        ...
        JLabel title = new JLabel("Fundamrntals Of Probability");
        ...
        JLabel lblTitle = new JLabel("Fundamrntals Of Probability");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This book provides a comprehensive introduction to the fundamentals of probability theory, covering essential concepts such as random variables, probability distributions, expectation, and statistical inference. It is designed for students and professionals seeking to build a solid foundation in probability for applications in various fields including statistics, finance, and engineering.");
        ...
        JLabel price = new JLabel(BooksCatalog.getPrice("Fundamrntals Of Probability"));
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Fundamentals Of Probability", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Fundamentals Of Probability", "Youssef N. Raffoul", priceText + " DA", "BooksImg\\ImgMath/FundamentalsOfProbability.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Differential Equations"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = FundamrntalsOfProbabilityBook.class.getResource(path.startsWith("/") ? path : "/" + path);
