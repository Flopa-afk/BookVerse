...
public class IntroducingAlgorithmsInC {
    public static void main(String[] args) {
        SwingUtilities.invokeLater(IntroducingAlgorithmsInC::createAndShow);
    }
    ...
    private static JPanel createMainPanel() {
        ...
        ImageIcon raw = loadIcon("BooksImg\\ImgAlgo/IntroductionAlgorithms.jpg");
        ...
        JLabel title = new JLabel("Introducing Algorithms In C");
        ...
        JLabel lblTitle = new JLabel("Introducing Algorithms In C");
        lblTitle.setFont(new Font("Serif", Font.BOLD, 20));
        lblTitle.setForeground(new Color(60, 0, 90));
        card.add(lblTitle);
        card.add(Box.createVerticalStrut(8));

        JTextArea desc = new JTextArea("This book provides a comprehensive introduction to algorithms using the C programming language. It covers fundamental concepts, data structures, and algorithm design techniques, making it an essential resource for students and professionals alike.");
        ...
        buy.addActionListener(e -> {
            ...
            AddToCartDialog dialog = new AddToCartDialog(null, "Introducing Algorithms In C", priceText + " DA");
            dialog.setVisible(true);
            if (dialog.isConfirmed()) {
                CartManager.addBook("Introducing Algorithms In C", "F. Engineer", priceText + " DA", "BooksImg\\ImgAlgo/IntroductionAlgorithms.jpg", dialog.getQuantity());
        ...
        categories.add(categoryChip("Data Structures"));
    ...
    private static ImageIcon loadIcon(String path) {
        java.net.URL url = IntroducingAlgorithmsInC.class.getResource(path.startsWith("/") ? path : "/" + path);
